(function(e) {
    ...
    "0423": function(e) {
        e.exports = {
            ...
            coin_compare_chart_widget: {
                ...
                crypto_market_cap_comparison: "仮想通貨時価総額比較"
            },
    ...
    "056c": function(e) {
        e.exports = {
            ...
            coin_compare_chart_widget: {
                powered_by: "此服務是由 %{name_start}%{name}%{name_end} 提供",
                crypto_price_comparison: "加密貨幣匯率比較",
                crypto_market_cap_comparison: "加密貨幣總市值比較"
            },
            coin_price_static_headline_widget: {
                powered_by: "此服務是由 %{name_start}%{name}%{name_end} 提供"
            },
            coin_price_chart_widget: {
                ...
                "24h_low": "24 小時低價",
                view_price_chart: "View %{coin} Price Chart",
                powered_by: "此服務是由 %{name_start}%{name}%{name_end} 為您提供"
            },
            coin_price_marquee_widget: {
                powered_by: "此服務是由 %{name_start}%{name}%{name_end} 提供"
            },
    ...
    "0825": function(e) {
        e.exports = {
            ...
            coin_compare_chart_widget: {
                ...
                crypto_price_comparison: "Prezzi delle criptovalute a confronto",
                crypto_market_cap_comparison: "Capitalizzazione di mercato delle criptovalute a confronto"
            },
            coin_price_static_headline_widget: {
                powered_by: "Offerto da %{name_start}%{name}%{name_end}"
            },
    ...
    3504: function(e) {
        e.exports = {
            ...
            coin_compare_chart_widget: {
                powered_by: "由%{name_start}%{name}%{name_end}推动",
                crypto_price_comparison: "加密价格比较",
                crypto_market_cap_comparison: "加密市值比较"
            },
            coin_price_static_headline_widget: {
                powered_by: "由%{name_start}%{name}%{name_end}推动"
            },
    ...
    "5d67": function(e) {
        e.exports = {
            coin_details: {
                mcap_rank: "Posição da capitalização no mercado",
            ...
            coin_compare_chart_widget: {
                ...
                crypto_price_comparison: "Comparação de preço de criptomoedas",
                crypto_market_cap_comparison: "Comparação de capitalização de mercado de criptomoedas"
            },
            coin_price_static_headline_widget: {
                powered_by: "Fornecido por %{name_start}%{name}%{name_end}"
            },
            ...
            coin_heatmap_widget: {
                title: "Mapa de árvore de criptomoedas",
                subtitle: "(Top %{top} by Market Cap)",
                powered_by: "Fornecido por %{name_start}%{name}%{name_end}"
            },
            random_coin_widget: {
            ...
            coin_market_ticker_list_widget: {
                ...
                price: "Preço",
                volume: "Volume",
                trust_score: "Pontuação de Liquidez",
                view_price_chart: "Ver tabela de preços",
                powered_by: "Fornecido por %{name_start}%{name}%{name_end}",
                view_all: "View all %{coin} markets"
            }
        }
    ...
    "6ce2": function(e) {
        e.exports = {
            ...
            coin_compare_chart_widget: {
                powered_by: "Präsentiert von %{name_start}%{name}%{name_end}",
                crypto_price_comparison: "Kryptowährungs-Preisvergleich",
                crypto_market_cap_comparison: "Vergleich der Kryptowährungs-Marktkapitalisierung"
            },
            coin_price_static_headline_widget: {
                powered_by: "Präsentiert von %{name_start}%{name}%{name_end}"
            },
            ...
            coin_market_ticker_list_widget: {
                ...
                view_price_chart: "Preisübersicht anzeigen",
                powered_by: "Präsentiert von %{name_start}%{name}%{name_end}",
                view_all: "View all %{coin} markets"
            }
        }
    ...
    7704: function(e) {
        e.exports = {
            coin_details: {
                mcap_rank: "Позиция в рейтинге Market Cap",
                mcap: "Рыночная капитализация",
                "24h_volume": "Объем за 24 часа",
                "24h_high_low": "24H High/Low"
            },
            coin_compare_chart_widget: {
                powered_by: "От %{name_start}%{name}%{name_end}",
                crypto_price_comparison: "Сравнение курсов криптовалют",
                crypto_market_cap_comparison: "Сравнение криптовалют по рыночной капитализации"
            },
            coin_price_static_headline_widget: {
                powered_by: "От %{name_start}%{name}%{name_end}"
            },
            ...
            coin_heatmap_widget: {
                title: "Карта дерева криптовалют",
                subtitle: "(Top %{top} by Market Cap)",
                powered_by: "От %{name_start}%{name}%{name_end}"
            },
            random_coin_widget: {
            ...
            coin_daily_price_widget: {
                title: "CoinGecko Price Update",
                total_mcap: "Total M cap",
                "24h_vol": "Объем торгов за 24 часа",
                dom: "Dom"
            },
            coin_market_ticker_list_widget: {
                exchange: "Обмен",
                ...
                price: "Цена",
                volume: "Объем",
                trust_score: "Показатель надежности",
                view_price_chart: "Показать график изменения курса",
                powered_by: "От %{name_start}%{name}%{name_end}",
                view_all: "View all %{coin} markets"
            }
        }
    ...
    8680: function(e) {
        e.exports = {
            coin_details: {
                mcap_rank: "อันดับมูลค่าตามราคาตลาด",
                mcap: "มูลค่าตามราคาตลาด",
                "24h_volume": "ปริมาณ 24 ชม.",
                "24h_high_low": "24H High/Low"
            },
            coin_compare_chart_widget: {
                powered_by: "ขับเคลื่อนด้วย %{name_start}%{name}%{name_end}",
                crypto_price_comparison: "การเปรียบเทียบราคา Crypto",
                crypto_market_cap_comparison: "การเปรียบเทียบมูลค่าตามราคาตลาดของ Crypto"
            },
            coin_price_static_headline_widget: {
                powered_by: "ขับเคลื่อนด้วย %{name_start}%{name}%{name_end}"
            },
            coin_price_chart_widget: {
                "24h_high": "สูง 24 ชั่วโมง",
                "24h_low": "ต่ำ 24 ชั่วโมง",
                view_price_chart: "View %{coin} Price Chart",
                powered_by: "ขับเคลื่อนด้วย %{name_start}%{name}%{name_end}"
            },
            coin_price_marquee_widget: {
            ...
            coin_heatmap_widget: {
                title: "แผนที่รูปต้นไหม Cryptocurrency",
                subtitle: "(Top %{top} by Market Cap)",
                powered_by: "ขับเคลื่อนด้วย %{name_start}%{name}%{name_end}"
            },
            random_coin_widget: {
            ...
            coin_market_ticker_list_widget: {
                ...
                price: "ราคา",
                volume: "ปริมาณ",
                trust_score: "คะแนนความเชื่อมั่น",
                view_price_chart: "ดูกราฟราคา",
                powered_by: "ขับเคลื่อนด้วย %{name_start}%{name}%{name_end}",
                view_all: "View all %{coin} markets"
            }
        }
    ...
    "89b2": function(e) {
        e.exports = {
            coin_details: {
                ...
                "24h_volume": "Wolumen – 24 godz.",
                "24h_high_low": "24H High/Low"
            },
            coin_compare_chart_widget: {
                powered_by: "Treść dostarczona przez %{name_start}%{name}%{name_end}",
                crypto_price_comparison: "Porównanie cen kryptowalut",
                crypto_market_cap_comparison: "Porównanie dominacji w kapitalizacji rynku kryptowalut"
            },
            coin_price_static_headline_widget: {
                powered_by: "Treść dostarczona przez %{name_start}%{name}%{name_end}"
            },
            coin_price_chart_widget: {
                "24h_high": "24 godz. – maks.",
                "24h_low": "24 godz. – min.",
                view_price_chart: "View %{coin} Price Chart",
                powered_by: "Treść dostarczona przez %{name_start}%{name}%{name_end}"
            },
            ...
            coin_market_ticker_list_widget: {
                ...
                view_price_chart: "Wyświetl wykres ceny",
                powered_by: "Treść dostarczona przez %{name_start}%{name}%{name_end}",
                view_all: "View all %{coin} markets"
            }
        }
    ...
    a306: function(e) {
        e.exports = {
            coin_details: {
                mcap_rank: "Clasificación de capitalización de mercado",
                mcap: "Cap. de mercado",
                "24h_volume": "Volumen en 24 h",
                "24h_high_low": "24H High/Low"
            },
            coin_compare_chart_widget: {
                powered_by: "Con tecnología de %{name_start}%{name}%{name_end}",
                crypto_price_comparison: "Comparación de precios de criptomonedas",
                crypto_market_cap_comparison: "Comparación de la capitalización de mercado de las criptomonedas"
            },
            coin_price_static_headline_widget: {
                powered_by: "Con tecnología de %{name_start}%{name}%{name_end}"
            },
            coin_price_chart_widget: {
                "24h_high": "Máximo en 24 h",
                "24h_low": "Mínimo en 24 h",
                view_price_chart: "View %{coin} Price Chart",
                powered_by: "Con tecnología de %{name_start}%{name}%{name_end}"
            },
            coin_price_marquee_widget: {
            ...
            coin_heatmap_widget: {
                title: "Mapa de árbol de criptomonedas",
                subtitle: "(Top %{top} by Market Cap)",
                powered_by: "Con tecnología de %{name_start}%{name}%{name_end}"
            },
            random_coin_widget: {
    ...
    aced: function(e) {
        e.exports = {
            coin_details: {
                mcap_rank: "Xếp hạng Vốn hóa thị trường",
                mcap: "Giá trị vốn hóa thị trường",
                "24h_volume": "Khối lượng trong 24h",
                "24h_high_low": "24H High/Low"
            },
            coin_compare_chart_widget: {
                powered_by: "Được hỗ trợ bởi %{name_start}%{name}%{name_end}",
                crypto_price_comparison: "So sánh giá tiền mã hóa",
                crypto_market_cap_comparison: "So sánh vốn hóa thị trường tiền mã hóa"
            },
            coin_price_static_headline_widget: {
                powered_by: "Được hỗ trợ bởi %{name_start}%{name}%{name_end}"
            },
            ...
            coin_market_ticker_list_widget: {
                ...
                view_price_chart: "Xem biểu đồ giá",
                powered_by: "Được hỗ trợ bởi %{name_start}%{name}%{name_end}",
                view_all: "View all %{coin} markets"
            }
        }
    ...
    af08: function(e) {
        e.exports = {
            coin_details: {
                mcap_rank: "تصنيف القيمة السوقية",
                mcap: "القيمة السوقية",
                "24h_volume": "حجم 24 ساعة",
                "24h_high_low": "24H High/Low"
            },
            coin_compare_chart_widget: {
                powered_by: "برعاية %{name_start}%{name}%{name_end}",
                crypto_price_comparison: "مقارنة أسعار العملة المشفرة",
                crypto_market_cap_comparison: "مقارنة سقف أسعار سوق العملات المشفرة"
            },
            coin_price_static_headline_widget: {
                powered_by: "برعاية %{name_start}%{name}%{name_end}"
            },
            coin_price_chart_widget: {
                "24h_high": "ارتفاع على مدار 24 ساعة",
                "24h_low": "انخفاض على مدار 24 ساعة",
                view_price_chart: "View %{coin} Price Chart",
                powered_by: "برعاية %{name_start}%{name}%{name_end}"
            },
            coin_price_marquee_widget: {
            ...
            coin_heatmap_widget: {
                title: "خريطة شجرة العملات المشفرة",
                subtitle: "(Top %{top} by Market Cap)",
                powered_by: "برعاية %{name_start}%{name}%{name_end}"
            },
            random_coin_widget: {
            ...
            coin_market_ticker_list_widget: {
                ...
                price: "السعر",
                volume: "حجم التداول",
                trust_score: "نتيجة الموثوقية",
                view_price_chart: "عرض مخطط السعر",
                powered_by: "برعاية %{name_start}%{name}%{name_end}",
                view_all: "View all %{coin} markets"
            }
        }
    ...
    dd11: function(e) {
        e.exports = {
            ...
            coin_compare_chart_widget: {
                powered_by: "Powered by %{name_start}%{name}%{name_end}",
                crypto_price_comparison: "암호화폐 가격 비교",
                crypto_market_cap_comparison: "암호화폐 시가총액 비교"
            },
            coin_price_static_headline_widget: {
                powered_by: "Powered by %{name_start}%{name}%{name_end}"
            },
    ...
    f693: function(e) {
        e.exports = {
            ...
            coin_compare_chart_widget: {
                ...
                crypto_market_cap_comparison: "Comparaison des capitalisations de marché de crypto"
            },
            coin_price_static_headline_widget: {
                powered_by: "Fourni par %{name_start}%{name}%{name_end}"
            },
            ...
            random_coin_widget: {
                disclaimer: "Clause de non responsabilité : Cet outil ne sert qu'à des fins de divertissement et ne constitue pas de conseils financiers",
                spin: "Tourner",
            ...
            coin_daily_price_widget: {
                title: "CoinGecko Price Update",
                total_mcap: "Total M cap",
                "24h_vol": "Volume sur 24 h",
                dom: "Dom"
            },
            coin_market_ticker_list_widget: {
                exchange: "Plate-forme d'échange",
                pair: "Paire",
                price: "Cours",
                volume: "Volume",
    ...
    ffeb: function(e) {
        e.exports = {
            coin_details: {
                mcap_rank: "Piyasa Değeri Sıralaması",
                mcap: "Piyasa Değeri",
                "24h_volume": "24 Saatlik Hacim",
                "24h_high_low": "24H High/Low"
            },
            coin_compare_chart_widget: {
                powered_by: "%{name_start}%{name}%{name_end} tarafından desteklenmektedir",
                crypto_price_comparison: "Kripto Fiyat Karşılaştırması",
                crypto_market_cap_comparison: "Kripto Piyasa Değeri Karşılaştırması"
            },
            coin_price_static_headline_widget: {
                powered_by: "%{name_start}%{name}%{name_end} tarafından desteklenmektedir"
            },
            ...
            coin_heatmap_widget: {
                title: "Kripto Para Ağacı Haritası",
                subtitle: "(Top %{top} by Market Cap)",
                powered_by: "%{name_start}%{name}%{name_end} tarafından desteklenmektedir"
            },
            random_coin_widget: {
            ...
            coin_market_ticker_list_widget: {
                ...
                view_price_chart: "Fiyat Tablosunu Gör",
                powered_by: "%{name_start}%{name}%{name_end} tarafından desteklenmektedir",
                view_all: "View all %{coin} markets"
            }
        }
